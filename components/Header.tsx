export default function Header() {
  return (
    <header className="relative flex w-full items-center justify-between border-b border-slate-200 bg-slate-900 px-6 py-4 text-white">
      <div className="w-8 hidden sm:block"></div>
      <h1 className="text-2xl font-semibold tracking-tight text-center flex-1">
        Dijkstra Solver
      </h1>
      <div className="flex items-center">
        <a
          href="https://github.com/naufalfaisa/dijkstra-solver"
          target="_blank"
